...
E/
├── README.md                       # 本文档
├── ecompiler.exe                   # 编译好的编译器
├── elang.exe                       # 编译器别名
├── output.asm                      # 生成的NASM汇编代码（临时）
├── output.o                       # 汇编目标文件（临时）
├── output.c                       # 生成的C代码（临时）
├── output.ir                      # 生成的中间表示（IR）代码（临时）
├── output.exe                      # 编译后的程序（临时）
├── src/                            # 编译器源代码
│   ├── lexer.c                     # 词法分析器
│   ├── lexer.h                     # 词法分析器头文件
│   ├── parser.c                    # 语法分析器
...
│   ├── codegen.c                   # C代码生成器
│   ├── codegen.h                   # C代码生成器头文件
│   ├── codegen_nasm.c              # NASM汇编代码生成器
│   ├── codegen_nasm.h              # NASM汇编代码生成器头文件
│   ├── codegen_ir.c                # IR和机器码生成器
│   ├── codegen_ir.h                # IR和机器码生成器头文件
│   ├── preprocessor.c              # 预处理器（一级/二级宏处理）
│   ├── preprocessor.h              # 预处理器头文件
│   └── main.c                      # 主程序入口
├── elhle/                          # VSCode插件（完整版本）
│   ├── out/
│   │   ├── extension.js            # 编译后的插件代码
│   │   └── extension.js.map        # 调试映射文件
│   ├── src/
│   │   └── extension.ts            # 插件源码（TypeScript）
│   ├── syntaxes/
│   │   └── E.tmLanguage.json       # 语法高亮定义
│   ├── .gitignore                  # Git忽略配置
│   ├── README.md                   # 插件说明文档
│   ├── elang-language-support-0.1.0.vsix  # 打包好的插件安装包
│   ├── language-configuration.json # 语言配置（括号匹配等）
│   ├── package-lock.json           # npm依赖锁定
│   ├── package.json                # npm配置
│   └── tsconfig.json               # TypeScript配置
├── elang-vscode-extension/         # VSCode插件（精简版本）
│   ├── out/
│   │   ├── extension.js
│   │   └── extension.js.map
│   ├── syntaxes/
│   │   └── E.tmLanguage.json
│   ├── README.md
│   ├── elang-language-support-0.1.0.vsix
